...
## [4.4.0](https://github.com/Robloche/shaka-player/compare/v4.4.0...v4.4.0) (2023-07-04)
...
* Add AAC transmuxer ([#5240](https://github.com/Robloche/shaka-player/issues/5240)) ([00d3a45](https://github.com/Robloche/shaka-player/commit/00d3a45dad5957f14640f38dec1068dfd2397698))
* Add AC-3 and EC-3 support in Mp4Generator ([#5235](https://github.com/Robloche/shaka-player/issues/5235)) ([28d18ad](https://github.com/Robloche/shaka-player/commit/28d18ad7a77134d5e7a301a9753d67ac0c698764))
...
* Add AC3 transmuxer ([#5297](https://github.com/Robloche/shaka-player/issues/5297)) ([6f83997](https://github.com/Robloche/shaka-player/commit/6f8399791352b6ccb6f3803c5163be4999c075f0))
...
* Add EC3 transmuxer ([#5352](https://github.com/Robloche/shaka-player/issues/5352)) ([7d24e14](https://github.com/Robloche/shaka-player/commit/7d24e14d2132ed3eee2a3f63e88892214755e717))
...
* Add liveSync configuration to catch up on live streams ([#5304](https://github.com/Robloche/shaka-player/issues/5304)) ([db44dc8](https://github.com/Robloche/shaka-player/commit/db44dc82242fd9dd845024737e969fef0e4caae5))
...
* Add preferredVideoHdrLevel config. ([#5370](https://github.com/Robloche/shaka-player/issues/5370)) ([2f511a2](https://github.com/Robloche/shaka-player/commit/2f511a293014f2b5e7c8b14db5dedcbb4f24e3fe))
* Add safeMargin as a parameter of the player selectAudioLanguage method ([#5316](https://github.com/Robloche/shaka-player/issues/5316)) ([e4a4138](https://github.com/Robloche/shaka-player/commit/e4a41381f2ac8b70d8419a2742bb7109cb0e2015))
...
* Add support to old EMSG schemeId for ID3 ([#5320](https://github.com/Robloche/shaka-player/issues/5320)) ([cd9ee09](https://github.com/Robloche/shaka-player/commit/cd9ee095e8864265b0b851c4d25bd2dc558c0e93))
* Add support to streamDataCallback when using prefetch ([#5310](https://github.com/Robloche/shaka-player/issues/5310)) ([6104b57](https://github.com/Robloche/shaka-player/commit/6104b57a76626f7b847b807ee07c543f90acbcad))
...
* **DASH:** Achieve better latency in LL streams ([#5291](https://github.com/Robloche/shaka-player/issues/5291)) ([f4bcc87](https://github.com/Robloche/shaka-player/commit/f4bcc874d87b45f9e6678d17466c921594ba0fc5))
...
* **DASH:** Remove MIN_UPDATE_PERIOD_ to achieve better latency in Live ([#5286](https://github.com/Robloche/shaka-player/issues/5286)) ([1515b7a](https://github.com/Robloche/shaka-player/commit/1515b7abf62a9e7227d428d0a90c303e7aecc45d))
* **Demo:** Add Low Latency filter in demo page ([#5392](https://github.com/Robloche/shaka-player/issues/5392)) ([c378e10](https://github.com/Robloche/shaka-player/commit/c378e10bc68a0a1552ab757201ad4c38cffa015d))
...
* export period combiner ([#5324](https://github.com/Robloche/shaka-player/issues/5324)) ([e9ba2f4](https://github.com/Robloche/shaka-player/commit/e9ba2f432210d82a1beae063b6323c4d46cc1765)), closes [#5307](https://github.com/Robloche/shaka-player/issues/5307)
...
* **HLS:** Add support to _HLS_msn query param in LL streams ([#5262](https://github.com/Robloche/shaka-player/issues/5262)) ([2ece86f](https://github.com/Robloche/shaka-player/commit/2ece86fde61e5f7f942c3bbdeb6eafe5fc50d8d0))
* **HLS:** Add support to _HLS_part query param in LL streams ([#5265](https://github.com/Robloche/shaka-player/issues/5265)) ([ec8804d](https://github.com/Robloche/shaka-player/commit/ec8804d0be2c2cd26a86bbd5737544261c29cc46))
* **HLS:** Add support to blocking playlist reload by adding the CAN-BLOCK-RELOAD=YES ([#5279](https://github.com/Robloche/shaka-player/issues/5279)) ([090554b](https://github.com/Robloche/shaka-player/commit/090554b9ed284e10e6de4305aa5ec7797ff8da3b))
* **HLS:** Add support to BYTERANGE-LENGTH in EXT-X-PRELOAD-HINT ([#5267](https://github.com/Robloche/shaka-player/issues/5267)) ([ea97a5a](https://github.com/Robloche/shaka-player/commit/ea97a5a90c3445405bfc53c96943ae607caf2e21))
...
* **HLS:** Add support to HOLD-BACK in EXT-X-SERVER-CONTROL ([#5281](https://github.com/Robloche/shaka-player/issues/5281)) ([bb2c06a](https://github.com/Robloche/shaka-player/commit/bb2c06a3df1a4d68c981b7bef13e12110b8d0ca7))
* **HLS:** Allow delivery directives in Live streams ([#5292](https://github.com/Robloche/shaka-player/issues/5292)) ([aedf634](https://github.com/Robloche/shaka-player/commit/aedf634f8ee9a8f0a172bfaa0d9b7b3f8ba3f294))
...
* **HLS:** Improve HLS parsing time ([#5264](https://github.com/Robloche/shaka-player/issues/5264)) ([2ca7d0b](https://github.com/Robloche/shaka-player/commit/2ca7d0b06075adce752cf048eb70693c837b1e9c))
...
* **HLS:** Optimization of LL-HLS with byterange ([#5319](https://github.com/Robloche/shaka-player/issues/5319)) ([9e6655a](https://github.com/Robloche/shaka-player/commit/9e6655a04a712641d53e4b717ca68f2120414d56))
* **HLS:** Optimize LL-HLS with byterange ([#5342](https://github.com/Robloche/shaka-player/issues/5342)) ([53d6378](https://github.com/Robloche/shaka-player/commit/53d6378bac540af8e69522d1e22887b56b598bf0))
* **HLS:** Parse SAMPLE-RATE attribute ([#5375](https://github.com/Robloche/shaka-player/issues/5375)) ([5af34ad](https://github.com/Robloche/shaka-player/commit/5af34add689ee5075b94eedf59125eec2f8a45c2))
...
* **HLS:** Support byterange optimization on servers with support to blocking playlist reload ([#5347](https://github.com/Robloche/shaka-player/issues/5347)) ([263a17b](https://github.com/Robloche/shaka-player/commit/263a17b984d7014e9d080e4b7437a78c7620aec7))
* Improve live latency on load ([#5268](https://github.com/Robloche/shaka-player/issues/5268)) ([236dacb](https://github.com/Robloche/shaka-player/commit/236dacb53bfc511ce3144e621b5f572f644e245d))
* Improve parsing time in DASH and HLS ([#5261](https://github.com/Robloche/shaka-player/issues/5261)) ([f1e35fd](https://github.com/Robloche/shaka-player/commit/f1e35fde00c65e6cf1acd42fb78c3b5562705542))
* Improve performance of multi-period DASH parsing ([#5350](https://github.com/Robloche/shaka-player/issues/5350)) ([5b0b429](https://github.com/Robloche/shaka-player/commit/5b0b4290e36091ff75da92fe307e7744799f4411))
* Improve performance of setStreamProperties on low-end devices ([#5380](https://github.com/Robloche/shaka-player/issues/5380)) ([ddbc249](https://github.com/Robloche/shaka-player/commit/ddbc2498bff6a3cb38fbebb37886e512d28720a0))
* Improve sequence mode start time ([#5326](https://github.com/Robloche/shaka-player/issues/5326)) ([80cacf6](https://github.com/Robloche/shaka-player/commit/80cacf6d8f28e3cd75f40b1c68d2e52a46219df6))
...
* Optimize appendBuffer operations for init segments ([#5377](https://github.com/Robloche/shaka-player/issues/5377)) ([68f7a0e](https://github.com/Robloche/shaka-player/commit/68f7a0eb2a8574645592e069c63813e0c97c5e66))
* Parses a PRFT Box, with a loss of precision beyond 53 bits ([#5354](https://github.com/Robloche/shaka-player/issues/5354)) ([a797651](https://github.com/Robloche/shaka-player/commit/a797651db4e636bd00cba3715686dc35057eb9de))
* Parses a TFDT Box, with a loss of precision beyond 53 bits ([#5329](https://github.com/Robloche/shaka-player/issues/5329)) ([db73e1f](https://github.com/Robloche/shaka-player/commit/db73e1f410f5e6754ea16329be35c48a48bca16d))
...
* Set segmentPrefetchLimit to 2 by default for low latency streaming ([#5275](https://github.com/Robloche/shaka-player/issues/5275)) ([62f24d2](https://github.com/Robloche/shaka-player/commit/62f24d22491353bf3a37f451c74a26b77f892197))
...
* Support private-use language tags ([#5223](https://github.com/Robloche/shaka-player/issues/5223)) ([fa041d7](https://github.com/Robloche/shaka-player/commit/fa041d776da720b9319e8db65aeb48df1d48a9bf))
* **UI:** Add HDR label to resolution when the track is HDR ([#5373](https://github.com/Robloche/shaka-player/issues/5373)) ([3f9eade](https://github.com/Robloche/shaka-player/commit/3f9eadeaaf5d3a4b4e20c6e05dbad3fc4b4b5f3c))
...
* **UI:** Remove copyStyleSheets ([#5273](https://github.com/Robloche/shaka-player/issues/5273)) ([fe43ed3](https://github.com/Robloche/shaka-player/commit/fe43ed3964509d6be0c1a2123787adf51c91fc33))
* **UI:** Use Intl.DisplayNames to show the language name ([#5365](https://github.com/Robloche/shaka-player/issues/5365)) ([35cb193](https://github.com/Robloche/shaka-player/commit/35cb193c76a01b0bdea862b423cfc6721f42529a))
...
* Add missing StreamInfo value in AAC transmuxer ([#5260](https://github.com/Robloche/shaka-player/issues/5260)) ([5175e88](https://github.com/Robloche/shaka-player/commit/5175e887af628a5163795e5213ea3cd5f2b2f809))
...
* **Ads:** Fix SS configure ([#5155](https://github.com/Robloche/shaka-player/issues/5155)) ([49ed4ab](https://github.com/Robloche/shaka-player/commit/49ed4ab33ffffb8ee8d05f2a2109c774ef98e6b9))
...
* Avoid unnecessary timestampOffset updates when using HLS segments mode ([#5270](https://github.com/Robloche/shaka-player/issues/5270)) ([9059944](https://github.com/Robloche/shaka-player/commit/90599440dcac8116fe369654716c38b84efffc5d))
...
* CEA 608 captions not work with H.265 video streams ([#5252](https://github.com/Robloche/shaka-player/issues/5252)) ([f0ee16b](https://github.com/Robloche/shaka-player/commit/f0ee16bdb35283e9543006c00ab45bf3ea06f002)), closes [#5251](https://github.com/Robloche/shaka-player/issues/5251)
...
* **DASH:** Avoid "Possible encoding problem detected!" when appending chunked data ([#5376](https://github.com/Robloche/shaka-player/issues/5376)) ([2071e3a](https://github.com/Robloche/shaka-player/commit/2071e3ae6302be3fcb15f774b85525f9067e5798))
...
* **DASH:** Ignore minBufferTime when using LL ([#5285](https://github.com/Robloche/shaka-player/issues/5285)) ([fea46d8](https://github.com/Robloche/shaka-player/commit/fea46d88cd9e2caef00b5ab272b0abcfb1251498))
* **Demo:** Allow enable LL only with Low Latency Mode config ([#5266](https://github.com/Robloche/shaka-player/issues/5266)) ([70823f9](https://github.com/Robloche/shaka-player/commit/70823f96a6c55d2eda8930cd72895dca89715c63))
...
* **Demo:** Fix deployment of codem-isoboxer in the Demo ([#5257](https://github.com/Robloche/shaka-player/issues/5257)) ([03b39f7](https://github.com/Robloche/shaka-player/commit/03b39f75dacfc6a14cafb6afced35a9cff05c6b0))
* **Demo:** Fix error link width to avoid overlap with close button ([#5309](https://github.com/Robloche/shaka-player/issues/5309)) ([08317d0](https://github.com/Robloche/shaka-player/commit/08317d063284acd298c6c27d73efdf58c08d9911))
...
* **Demo:** Trim custom manifestUri to avoid copy-paste errors ([#5378](https://github.com/Robloche/shaka-player/issues/5378)) ([0e32256](https://github.com/Robloche/shaka-player/commit/0e322566dc9f51c4478e3b93fc467759c5ca1b94))
* **docs:** fix player configuration code in drm config tutorial ([#5359](https://github.com/Robloche/shaka-player/issues/5359)) ([5487236](https://github.com/Robloche/shaka-player/commit/5487236668d1d5178dd287af78b47ea0a647ffa1))
...
* **DRM:** broken keySystemsMapping due to multiple references of drmInfo ([#5388](https://github.com/Robloche/shaka-player/issues/5388)) ([6513ac0](https://github.com/Robloche/shaka-player/commit/6513ac056e5fd3ee9aecbb234c724119b058ef8d))
...
* Fix DASH rejection of streams with ColourPrimaries and MatrixCoefficients ([#5345](https://github.com/Robloche/shaka-player/issues/5345)) ([226ffa9](https://github.com/Robloche/shaka-player/commit/226ffa9df6cc9c539febfc205886098d79b2281d))
...
* Fix error when network status changes on src= playbacks ([#5305](https://github.com/Robloche/shaka-player/issues/5305)) ([07ca8f5](https://github.com/Robloche/shaka-player/commit/07ca8f535a1bb16973754372276613d20fbe2c41))
...
* Fix exception enabling captions on HLS ([#4894](https://github.com/Robloche/shaka-player/issues/4894)) ([b7b2a7c](https://github.com/Robloche/shaka-player/commit/b7b2a7cbe9f1b23ca184617a2c51f26cc85bf0a3)), closes [#4889](https://github.com/Robloche/shaka-player/issues/4889)
...
* Fix implementation of AAC and MP3 transmuxers ([#5296](https://github.com/Robloche/shaka-player/issues/5296)) ([df18f10](https://github.com/Robloche/shaka-player/commit/df18f10fca1b0ad643d9ee8dc02cc5bdbd22bab7))
...
* Fix MediaCapabilities polyfill on Hisense ([#4927](https://github.com/Robloche/shaka-player/issues/4927)) ([6a48cfe](https://github.com/Robloche/shaka-player/commit/6a48cfe64da49c49aeaabeb646b0233537a2ae3e))
...
* Fix temporarily disable streams on network error ([#5057](https://github.com/Robloche/shaka-player/issues/5057)) ([fdc5cb1](https://github.com/Robloche/shaka-player/commit/fdc5cb165d1cf02e48de8c814efaae6eb54a3dbe)), closes [#5055](https://github.com/Robloche/shaka-player/issues/5055) [#5150](https://github.com/Robloche/shaka-player/issues/5150)
...
* gap jumping when gap exists at start position ([#5384](https://github.com/Robloche/shaka-player/issues/5384)) ([6c71b0e](https://github.com/Robloche/shaka-player/commit/6c71b0ee63fce62c9074788e255363dbbc9ba4e1))
* Get the correct timescale when there are two trak boxes ([#5327](https://github.com/Robloche/shaka-player/issues/5327)) ([022f6b9](https://github.com/Robloche/shaka-player/commit/022f6b96fb6620446fe14e0f6e25b5d81c92aefa))
...
* **HLS:** Avoid "Possible encoding problem detected!" when is a preload reference ([#5332](https://github.com/Robloche/shaka-player/issues/5332)) ([bd18a9d](https://github.com/Robloche/shaka-player/commit/bd18a9de6068388849dd8af4088ce1e1b770d9c6))
* **HLS:** Avoid HLS resync when there is a gap in the stream ([#5284](https://github.com/Robloche/shaka-player/issues/5284)) ([b8c2004](https://github.com/Robloche/shaka-player/commit/b8c2004e0203b002fb3ea6fec740a53d48d74b33))
* **HLS:** Avoid variable substitution if no variables ([#5269](https://github.com/Robloche/shaka-player/issues/5269)) ([5a5a7ac](https://github.com/Robloche/shaka-player/commit/5a5a7acf5112148e62dfd033c3be568b8f4a56b5))
...
* **HLS:** Don't do sequence mode workaround unless there's a text stream ([#5315](https://github.com/Robloche/shaka-player/issues/5315)) ([019dcfd](https://github.com/Robloche/shaka-player/commit/019dcfd9a298516797ab189384f506c416cf7d18))
...
* **HLS:** Fix AV sync over ad boundaries ([#4824](https://github.com/Robloche/shaka-player/issues/4824)) ([35033bb](https://github.com/Robloche/shaka-player/commit/35033bb2db1ca630f4f7895e7678bd0ee6cfd9ef)), closes [#4589](https://github.com/Robloche/shaka-player/issues/4589)
* **HLS:** Fix avoid prefetch missing segments ([#5372](https://github.com/Robloche/shaka-player/issues/5372)) ([7f8e051](https://github.com/Robloche/shaka-player/commit/7f8e051886e6aab1b7a1997a600f982ca38c0c6c))
...
* **HLS:** Fix dvh1 and dvhe detection as video codec ([#5364](https://github.com/Robloche/shaka-player/issues/5364)) ([37b7be6](https://github.com/Robloche/shaka-player/commit/37b7be60b2d560f72e5149918007d4f1cd655e77))
* **HLS:** Fix HLS seekRange for live streams ([#5263](https://github.com/Robloche/shaka-player/issues/5263)) ([258962f](https://github.com/Robloche/shaka-player/commit/258962f9e0a9a7df6c13db7dbf0e8a54cd3a2ae2))
...
* **HLS:** Fix live playlist update when using no LL in a LL stream ([#5282](https://github.com/Robloche/shaka-player/issues/5282)) ([ad2eef6](https://github.com/Robloche/shaka-player/commit/ad2eef6952b6164a67a5ab1d85f3a0e7071eb7cd))
* **HLS:** Fix load of LL-HLS when the partial segment is not independent ([#5277](https://github.com/Robloche/shaka-player/issues/5277)) ([ed5915e](https://github.com/Robloche/shaka-player/commit/ed5915e437db16983a5a8c84f900367af4736cb4))
...
* **HLS:** Fix prefetch with LL-HLS stream ([#5274](https://github.com/Robloche/shaka-player/issues/5274)) ([551422a](https://github.com/Robloche/shaka-player/commit/551422a6f6a8da8a97485bee5552fd118ff933e7))
* **HLS:** Fix seek on LL streams when using segments mode ([#5283](https://github.com/Robloche/shaka-player/issues/5283)) ([d4f3f5c](https://github.com/Robloche/shaka-player/commit/d4f3f5c0686f0a6304bafbd86f9baf8a2bc6b9fb))
...
* **hls:** Fix type error in lazy-loading ([#4687](https://github.com/Robloche/shaka-player/issues/4687)) ([28b73b9](https://github.com/Robloche/shaka-player/commit/28b73b921d1dbdc6d7e016aa8e0a000e62318ed3))
* **HLS:** Ignore segments with zero duration ([#5371](https://github.com/Robloche/shaka-player/issues/5371)) ([c25b26a](https://github.com/Robloche/shaka-player/commit/c25b26a26a7e930af9455bae2f9d82804b921b7b))
...
* **HLS:** Mark first partial segment as independent always ([#5312](https://github.com/Robloche/shaka-player/issues/5312)) ([ea896d5](https://github.com/Robloche/shaka-player/commit/ea896d5bd71127147c4e31c9da2f3737cae6abc6))
* **HLS:** Parse EXT-X-PART-INF as media playlist tag ([#5311](https://github.com/Robloche/shaka-player/issues/5311)) ([d29f4bc](https://github.com/Robloche/shaka-player/commit/d29f4bc5b5188397f746ba3b3d74bd9620975219))
...
* **HLS:** Require SegmentIndex to return independent segments only ([#5288](https://github.com/Robloche/shaka-player/issues/5288)) ([9f80e3c](https://github.com/Robloche/shaka-player/commit/9f80e3cda6348a4952ffa3d624120f4105bbb926))
...
* **HLS:** Skip EXT-X-PRELOAD-HINT without full byterange info ([#5294](https://github.com/Robloche/shaka-player/issues/5294)) ([32d141d](https://github.com/Robloche/shaka-player/commit/32d141d7e2bf43a0aa0928ff2814fc556a264e87))
...
* **HLS:** Supports syncTime in partial segments ([#5280](https://github.com/Robloche/shaka-player/issues/5280)) ([9dddc09](https://github.com/Robloche/shaka-player/commit/9dddc09b897686ae5f838c1207ae2a77646ee1a1))
...
* **media:** Fix region checking in livestreams ([#5361](https://github.com/Robloche/shaka-player/issues/5361)) ([9fffcb9](https://github.com/Robloche/shaka-player/commit/9fffcb9ea627832b3a49df0cfb094a8fd153866a)), closes [#5213](https://github.com/Robloche/shaka-player/issues/5213)
...
* Only parse/probe TS if the reference is not an MP4 and not WebM ([#5381](https://github.com/Robloche/shaka-player/issues/5381)) ([b1e7cc4](https://github.com/Robloche/shaka-player/commit/b1e7cc4e67373d7ae7ab083fe5b626e28282e96b))
...
* Populate HDR correctly ([#5369](https://github.com/Robloche/shaka-player/issues/5369)) ([1ad75ec](https://github.com/Robloche/shaka-player/commit/1ad75ec8b7da2afe75a5d41fe027c016679f5873))
* prevent access to null config_ in SimpleAbrManager ([#5362](https://github.com/Robloche/shaka-player/issues/5362)) ([d1db694](https://github.com/Robloche/shaka-player/commit/d1db694f6e58d27ae40e9b37f8fd8238c5d4d167))
...
* Ship to NPM without node version restrictions ([#5253](https://github.com/Robloche/shaka-player/issues/5253)) ([524a80b](https://github.com/Robloche/shaka-player/commit/524a80b4498d63c67efb97554641e41860270e83)), closes [#5243](https://github.com/Robloche/shaka-player/issues/5243)
...
* Sync each segment against EXT-X-PROGRAM-DATE-TIME ([#4870](https://github.com/Robloche/shaka-player/issues/4870)) ([699657b](https://github.com/Robloche/shaka-player/commit/699657b929537af2b3f7b2a30b8bdf81a03c82a3)), closes [#4589](https://github.com/Robloche/shaka-player/issues/4589)
...
* **UI:** Fix resolution selection on src= ([#5367](https://github.com/Robloche/shaka-player/issues/5367)) ([3863c73](https://github.com/Robloche/shaka-player/commit/3863c73a15343e7879385c636a47c4a077d84e87))
...
* **UI:** Use pagehide instead of unload for PiP ([#5303](https://github.com/Robloche/shaka-player/issues/5303)) ([a543b80](https://github.com/Robloche/shaka-player/commit/a543b80648f429524c522295b0f4f60039c2e0ea))
* unnecessary parsing of in-band pssh when pssh is in the manifest ([#5198](https://github.com/Robloche/shaka-player/issues/5198)) ([05aa931](https://github.com/Robloche/shaka-player/commit/05aa93146129240f15309a4c7d04e531ee8edd57)), closes [#5197](https://github.com/Robloche/shaka-player/issues/5197)
...
* WebVTT position setting not working ([#4486](https://github.com/Robloche/shaka-player/issues/4486)) ([875d261](https://github.com/Robloche/shaka-player/commit/875d2618adc729ea8b7953d6fd493701ccf1b12c))
* WebVTT position setting not working ([#4486](https://github.com/Robloche/shaka-player/issues/4486)) ([6d59719](https://github.com/Robloche/shaka-player/commit/6d59719987c261c7e3fac9f712ff9e4638e9a7b7))
...
* **WebVTT:** Add support to middle position ([#5366](https://github.com/Robloche/shaka-player/issues/5366)) ([5691d5e](https://github.com/Robloche/shaka-player/commit/5691d5e4592ffdf712fc830547691f464fed031a))
